...
class CommandLogService extends BaseLogService
{
    /**
    ...
    public function info(string $message, array $extras = [], int $code = Response::HTTP_PROCESSING)
    {
        ...
        return $this->infoLog($message, Log::SOURCE_COMMAND, $extras, $code);
    }
    ...
    {
        return $this->warningLog($message, Log::SOURCE_COMMAND, $extras, $code);
    }
    ...
    {
        return $this->errorLog($message, Log::SOURCE_COMMAND, $extras, $code);
    }
}